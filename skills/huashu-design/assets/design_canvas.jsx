/**
 * DesignCanvas — 設計變體並排網格佈局
 *
 * 用於展示 2+ 個靜態設計 variation 讓使用者對比選擇。
 * 每個 variation 有 label，可 hover 放大。
 *
 * 用法：
 *   <DesignCanvas
 *     title="Hero 區設計探索"
 ...
 *   </DesignCanvas>
 *
 * 配合 React + Babel 使用。放在適當的 script 裡，window.DesignCanvas/window.Variation 即可使用。
 */
