 ...
 *
 * Stage + Sprite 模式，參考 Remotion 但輕量化。
 *
 * 匯出（掛到 window.Animations）：
 * - Stage: 整個動畫容器，提供時間 + 控制
 * - Sprite: 時間片段，start/end 內顯示，提供本地進度
 * - useTime(): 讀取全域時間（秒）
 * - useSprite(): 讀取本地進度 {t: 0→1, elapsed: seconds, duration: seconds}
 ...
 *   </Stage>
 *
 * 在 Sprite 子元件裡用 useSprite() 讀取當前片段進度。
 */
